...
MIRROR_HOSTS = frozenset([
  'no-firewall.appspot.com',
  'no-firewall1.appspot.com',
  'no-firewall2.appspot.com',
  'no-firewall3.appspot.com',
  'no-firewall4.appspot.com',
  'no-firewall5.appspot.com',
  'no-firewall6.appspot.com',
])
...
class HomeHandler(BaseHandler):
  def get(self):
    ...
    if self.request.scheme == "http":
      secure_url = "https://no-firewall.appspot.com"
    context = {
      "latest_urls": latest_urls,
      "secure_url": secure_url,
    }
    self.response.out.write(template.render("main_abhi.html", context))
